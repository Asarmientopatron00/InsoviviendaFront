...
import PersonaAsesoriaCreador from './PersonaAsesoriaCreador';
import {
   onGetColeccion, 
   onDelete,
                  ...
                  <Box className = {classes.titleTop}>
                     ...
                     <Box className = {classes.horizontalBottoms}>
                        ...
                        {permisos.indexOf('Crear') >= 0 && (
                           <Tooltip 
                              title = 'Crear asesoria a persona' 
                              onClick = { onOpenAddPersonaAsesoria }>
                              <IconButton
...
EnhancedTableToolbar.propTypes = {
   numSelected: PropTypes.number.isRequired,
   onOpenAddPersonaAsesoria: PropTypes.func.isRequired,
...
const PersonaAsesorias = (props) => {
  ...
  // const [dense, setDense] = React.useState(false);
   ...
   const [personaAsesoriaSeleccionado, setPersonaAsesoriaSeleccionado] = useState(0);
   ...
   const onOpenEditPersonaAsesoria = (id) => {
      setPersonaAsesoriaSeleccionado(id);
      setAccion('editar');
      setShowForm(true);
   };
   ...
   const onOpenViewPersonaAsesoria = (id) => {
      setPersonaAsesoriaSeleccionado(id);
      setAccion('ver');
      setShowForm(true);
   };

   const onDeletePersonaAsesoria = (id) => {
      Swal.fire({
         title: 'Confirmar',
         text: '¿ Seguro que desea eliminar la Asesoria a persona ?',
   ...
   const onOpenAddPersonaAsesoria = () => {
      setPersonaAsesoriaSeleccionado(0);
      setAccion('crear');
      setShowForm(true);
   };
   ...
   return (
      <div className = {classes.root}>
         <Paper className = {classes.paper}>
            { permisos && (
               <EnhancedTableToolbar
                  ...
                  onOpenAddPersonaAsesoria = {onOpenAddPersonaAsesoria}
                                       ...
                                       <TableCell align = 'center' className = {classes.acciones}>
                                          {permisos.indexOf('Modificar') >= 0 && (
                                             <Tooltip title = {<IntlMessages id = 'boton.editar' />}>
                                                <EditIcon
                                                   onClick = {() => onOpenEditPersonaAsesoria(row.id)}
                                          ...
                                          {permisos.indexOf('Listar') >= 0 && (
                                             <Tooltip title = {<IntlMessages id = 'boton.ver' />}>
                                                <VisibilityIcon
                                                   onClick = {() => onOpenViewPersonaAsesoria(row.id)}
                                          ...
                                          {permisos.indexOf('Eliminar') >= 0 && (
                                             <Tooltip
                                                ...
                                                <DeleteIcon
                                                   onClick = {() => onDeletePersonaAsesoria(row.id)}
         ...
         {showForm 
            ? (<PersonaAsesoriaCreador
               showForm = {showForm}
               personaAsesoria = {personaAsesoriaSeleccionado}
               accion = {accion}
...
export default PersonaAsesorias;
