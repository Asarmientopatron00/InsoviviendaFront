...
const cells = [
  ...
  {
    id: 'pagDetValorCapitalCuotaCondonado',
    typeHead: 'numeric',
    label: 'Capital Condonado',
    value: (value) =>  currencyFormatter.format(value),
    align: 'right',
    mostrarInicio: false,
  },
  ...
  {
    id: 'pagDetValorInteresCuotaCondonado',
    typeHead: 'numeric',
  ...
  {
    id: 'pagDetValorSeguroCuotaCondonado',
    typeHead: 'numeric',
    label: 'Seguro Condonado',
    value: (value) =>  currencyFormatter.format(value),
    align: 'right',
    mostrarInicio: false,
  },
  ...
  {
    id: 'pagDetValorInteresMoraCondonado',
    typeHead: 'numeric',
    label: 'Int. Mora Condonado',
    value: (value) =>  currencyFormatter.format(value),
    align: 'right',
    mostrarInicio: false,
  },
