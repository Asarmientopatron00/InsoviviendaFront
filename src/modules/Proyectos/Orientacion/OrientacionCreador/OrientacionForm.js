...
const OrientacionForm = (props) => {
  const {handleOnClose, accion, initialValues, titulo,
     tiposAsesorias, 
     asesores, 
     personas
    } = props;
        ...
        <Box py={5} px={{xs: 5, lg: 8, xl: 10}}>
          ...
          <Box px={{md: 5, lg: 8, xl: 10}}>
            <MyAutocomplete
              ...
              inputValue={initialValues.tipo_orientacion_id}
              required
              disabled={disabled}
            />
            <MyAutocomplete
              ...
              name='orientador_id'
              inputValue={initialValues.orientador_id}
              label='Asesor'
              className={classes.myTextField}
              required
              disabled={disabled}
            ...
            <MyAutocomplete
              ...
              name='persona_id'
              inputValue={initialValues.persona_id}
              label='Identificador Personas'
              className={classes.myTextField}
              required
              disabled={disabled}
            />
