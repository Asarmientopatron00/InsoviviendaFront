...
import {
  onDelete,
  onGetColeccionGestionC,
} from '../../../redux/actions/ProyectoAction';
import GestionCarteraCreador from './GestionCarteraCreador';
...
const cells = [
  ...
  },
  {
    ...
    value: (value) =>
      ESTADOS_PROYECTO.map((estadoProyecto) =>
  ...
  },
  {
    ...
    label: 'Remitido',
    value: (value) =>
      DATO_BOOLEAN.map((dato) => (dato.id === value ? dato.nombre : '')),
    align: 'left',
    mostrarInicio: false,
  },
  {
  ...
  },
  {
    ...
    label: 'Zona',
    value: (value) =>
      ZONA.map((zona) => (zona.id === value ? zona.nombre : '')),
    align: 'left',
    mostrarInicio: false,
  },
  {
  ...
  },
  {
    ...
    value: (value) =>
      TIPOS_CUENTA_RECAUDO.map((tipoCuentaRecaudo) =>
        tipoCuentaRecaudo.id === value ? tipoCuentaRecaudo.nombre : '',
      ),
    align: 'left',
    mostrarInicio: false,
  },
  ...
  },
  {
    ...
    label: 'Id Proyecto',
    value: (value) =>
      ESTADOS_FORMALIZACION.map((estadoForm) =>
        estadoForm.id === value ? estadoForm.nombre : '',
      ),
    align: 'left',
    mostrarInicio: false,
  },
...
function EnhancedTableHead(props) {
  const {classes, order, orderBy, onRequestSort, columnasMostradas, buscador} =
    props;
...
const Proyecto = (props) => {
  ...
  useEffect(() => {
    setPage(1);
  }, [orderByToSend, debouncedFilters]);
                              ...
                              <Tooltip title={'Plan Amort. Def.'}>
                                <Box
                                  ...
                                  <Money
                                    ...
                                    onClick={() =>
                                      onGoPlanAmortizacionDefinitivo(row.id)
                                    }
