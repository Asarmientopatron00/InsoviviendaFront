                  ...
                  <Box className = { classes.titleTop }>
                     <Box
                        ...
                        <Typography
                           ...
                           id = 'tableTitle'
                           component = 'div'>
                           Proyectos - Plan Amortización Definitivo
                        </Typography>
                     </Box>
                     <Box className = { classes.horizontalBottoms }>
                        <Formik>
                           <Form>
                              { permisos.indexOf('ExportarPlAmDePro') >= 0 && (
                                 <Tooltip
                                    ...
                                    href = {
                                       ...
                                       '/proyectos/plan-amortizacion-definitivo' +
                                       '?proyecto_id=' +
                                       proyecto_id
                                    }>
                                    <IconButton
...
const PlanAmortizacionDefinitivo = (props) => { 
   ...
   const headers = useSelector( ( { planAmortizacionDefinitivoReducer } ) => planAmortizacionDefinitivoReducer.ligera );
...
export default PlanAmortizacionDefinitivo;
