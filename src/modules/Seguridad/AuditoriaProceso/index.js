...
import {onGetColeccion} from '../../../redux/actions/AuditoriaProcesoAction';
...
const cells = [
  ...
  {
    id: 'audProUsuarioCreacionNombre',
    typeHead: 'string',
    label: 'Responsable',
    value: (value) => value,
    align: 'left',
        ...
        <>
          ...
          <Box className={classes.contenedorFiltros}>
            ...
            <TextField
              ...
              name='numeroProyectoFiltro'
              id='numeroProyectoFiltro'
              onChange={queryFilter}
              value={numeroProyectoFiltro}
              className={classes.inputFiltros}
            />
            <TextField
              label='Fecha Desde'
...
const AuditoriaProceso = (props) => {
  ...
  const [numeroProyectoFiltro, setNumeroProyectoFiltro] = useState('');
  ...
  const debouncedReponsableName = useDebounce(nombreResponsableFiltro, 800);
  const debouncedProjectNumber = useDebounce(numeroProyectoFiltro, 800);
  const debouncedResourceDes = useDebounce(descripcionRecursoFiltro, 800);
  const debouncedType = useDebounce(tipoFiltro, 800);
  ...
  const queryFilter = (e) => {
    switch (e.target.name) {
      ...
      case 'nombreResponsableFiltro':
        ...
        break;
      case 'numeroProyectoFiltro':
        setNumeroProyectoFiltro(e.target.value);
        break;
      ...
      <Paper className={classes.paper}>
        {permisos && (
          <EnhancedTableToolbar
            ...
            numeroProyectoFiltro={numeroProyectoFiltro}
