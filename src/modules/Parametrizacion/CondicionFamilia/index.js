...
import CondicionFamiliaCreador from './CondicionFamiliaCreador';
import {
  onGetColeccion,
  onDelete,
} from '../../../redux/actions/CondicionFamiliaAction';
          ...
          <Box className={classes.titleTop}>
            ...
            <Box className={classes.horizontalBottoms}>
              ...
              {permisos.indexOf('Crear') >= 0 && (
                <Tooltip title='Crear Condicion Familia' onClick={onOpenAddCondicionFamilia}>
                  <IconButton
...
EnhancedTableToolbar.propTypes = {
  numSelected: PropTypes.number.isRequired,
  onOpenAddCondicionFamilia: PropTypes.func.isRequired,
...
const CondicionFamilia = (props) => {
  ...
  const [condicionFamiliaSeleccionado, setCondicionFamiliaSeleccionado] = useState(0);
  ...
  const onOpenEditCondicionFamilia = (id) => {
    setCondicionFamiliaSeleccionado(id);
    setAccion('editar');
    setShowForm(true);
  };
  ...
  const onDeleteTipoIdentificacion = (id) => {
    Swal.fire({
      title: 'Confirmar',
      text: '¿Seguro Que Desea Eliminar La Condicion de Familia?',
  ...
  const onOpenAddCondicionFamilia = () => {
    setCondicionFamiliaSeleccionado(0);
    setAccion('crear');
    setShowForm(true);
  };
  ...
  return (
    <div className={classes.root}>
      <Paper className={classes.paper}>
        {permisos && (
          <EnhancedTableToolbar
            ...
            onOpenAddCondicionFamilia={onOpenAddCondicionFamilia}
                        ...
                        <TableCell align='center' className={classes.acciones}>
                          {permisos.indexOf('Modificar') >= 0 && (
                            <Tooltip title={<IntlMessages id='boton.editar' />}>
                              <EditIcon
                                onClick={() => onOpenEditCondicionFamilia(row.id)}
      ...
      {showForm ? (
        <CondicionFamiliaCreador
          showForm={showForm}
          tipoIdentificacion={condicionFamiliaSeleccionado}
          accion={accion}
...
export default CondicionFamilia;
