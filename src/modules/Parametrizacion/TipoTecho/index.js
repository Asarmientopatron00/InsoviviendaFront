...
import TipoTechoCreador from './TipoTechoCreador';
import {
  onGetColeccion,
  onDelete,
} from '../../../redux/actions/TipoTechoAction';
          ...
          <Box className={classes.titleTop}>
            ...
            <Box className={classes.horizontalBottoms}>
              ...
              {permisos.indexOf('Crear') >= 0 && (
                <Tooltip title='Crear Tipo de Techo' onClick={onOpenAddTipoTecho}>
                  <IconButton
...
EnhancedTableToolbar.propTypes = {
  numSelected: PropTypes.number.isRequired,
  onOpenAddTipoTecho: PropTypes.func.isRequired,
...
const TipoTecho = (props) => {
  ...
  const [tipoTechoSeleccionado, setTipoTechoSeleccionado] = useState(0);
  ...
  const onOpenEditTipoTecho = (id) => {
    setTipoTechoSeleccionado(id);
    setAccion('editar');
    setShowForm(true);
  };
  ...
  const onDeleteTipoIdentificacion = (id) => {
    Swal.fire({
      title: 'Confirmar',
      text: '¿Seguro Que Desea Eliminar el Tipo de Techo?',
  ...
  const onOpenAddTipoTecho = () => {
    setTipoTechoSeleccionado(0);
    setAccion('crear');
    setShowForm(true);
  };
  ...
  return (
    <div className={classes.root}>
      <Paper className={classes.paper}>
        {permisos && (
          <EnhancedTableToolbar
            ...
            onOpenAddTipoTecho={onOpenAddTipoTecho}
                        ...
                        <TableCell align='center' className={classes.acciones}>
                          {permisos.indexOf('Modificar') >= 0 && (
                            <Tooltip title={<IntlMessages id='boton.editar' />}>
                              <EditIcon
                                onClick={() => onOpenEditTipoTecho(row.id)}
      ...
      {showForm ? (
        <TipoTechoCreador
          showForm={showForm}
          tipoTecho={tipoTechoSeleccionado}
          accion={accion}
