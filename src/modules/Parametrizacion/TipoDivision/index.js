...
import TipoDivisionCreador from './TipoDivisionCreador';
import {
  onGetColeccion,
  onDelete,
} from '../../../redux/actions/TipoDivisionAction';
          ...
          <Box className={classes.titleTop}>
            ...
            <Box className={classes.horizontalBottoms}>
              ...
              {permisos.indexOf('Crear') >= 0 && (
                <Tooltip title='Crear Tipo de Division' onClick={onOpenAddTipoDivision}>
                  <IconButton
...
EnhancedTableToolbar.propTypes = {
  numSelected: PropTypes.number.isRequired,
  onOpenAddTipoDivision: PropTypes.func.isRequired,
...
const TipoDivision = (props) => {
  ...
  const [tipoDivisionSeleccionado, setTipoDivisionSeleccionado] = useState(0);
  ...
  const onOpenEditTipoDivision = (id) => {
    setTipoDivisionSeleccionado(id);
    setAccion('editar');
    setShowForm(true);
  };
  ...
  const onDeleteTipoIdentificacion = (id) => {
    Swal.fire({
      title: 'Confirmar',
      text: '¿Seguro Que Desea Eliminar el Tipo de Division?',
  ...
  const onOpenAddTipoDivision = () => {
    setTipoDivisionSeleccionado(0);
    setAccion('crear');
    setShowForm(true);
  };
  ...
  return (
    <div className={classes.root}>
      <Paper className={classes.paper}>
        {permisos && (
          <EnhancedTableToolbar
            ...
            onOpenAddTipoDivision={onOpenAddTipoDivision}
                        ...
                        <TableCell align='center' className={classes.acciones}>
                          {permisos.indexOf('Modificar') >= 0 && (
                            <Tooltip title={<IntlMessages id='boton.editar' />}>
                              <EditIcon
                                onClick={() => onOpenEditTipoDivision(row.id)}
      ...
      {showForm ? (
        <TipoDivisionCreador
          showForm={showForm}
          tipoDivision={tipoDivisionSeleccionado}
          accion={accion}
