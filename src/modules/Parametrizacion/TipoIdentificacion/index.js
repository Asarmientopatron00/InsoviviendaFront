...
import TipoIdentificacionCreador from './TipoIdentificacionCreador';
import {
  onGetColeccion,
  onDelete,
          ...
          <Box className={classes.titleTop}>
            ...
            <Box className={classes.horizontalBottoms}>
              ...
              {permisos.indexOf('Crear') >= 0 && (
                <Tooltip title='Crear Tipo de Identificación' onClick={onOpenAddTipoIdentificacion}>
                  <IconButton
...
EnhancedTableToolbar.propTypes = {
  numSelected: PropTypes.number.isRequired,
  onOpenAddTipoIdentificacion: PropTypes.func.isRequired,
...
const TiposIdentificacion = (props) => {
  ...
  const onOpenAddTipoIdentificacion = () => {
      ...
      <Paper className={classes.paper}>
        {permisos && (
          <EnhancedTableToolbar
            ...
            onOpenAddTipoIdentificacion={onOpenAddTipoIdentificacion}
