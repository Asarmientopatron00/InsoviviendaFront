...
import TipoPisoCreador from './TipoPisoCreador';
import {
  onGetColeccion,
  onDelete,
} from '../../../redux/actions/TipoPisoAction';
          ...
          <Box className={classes.titleTop}>
            ...
            <Box className={classes.horizontalBottoms}>
              ...
              {permisos.indexOf('Crear') >= 0 && (
                <Tooltip title='Crear Tipo de Piso' onClick={onOpenAddTipoPiso}>
                  <IconButton
...
EnhancedTableToolbar.propTypes = {
  numSelected: PropTypes.number.isRequired,
  onOpenAddTipoPiso: PropTypes.func.isRequired,
...
const TipoPiso = (props) => {
  ...
  const [tipoPisoSeleccionado, setTipoPisoSeleccionado] = useState(0);
  ...
  const onOpenEditTipoPiso = (id) => {
    setTipoPisoSeleccionado(id);
    setAccion('editar');
    setShowForm(true);
  };
  ...
  const onDeleteTipoIdentificacion = (id) => {
    Swal.fire({
      title: 'Confirmar',
      text: '¿Seguro Que Desea Eliminar el Tipo de Piso?',
  ...
  const onOpenAddTipoPiso = () => {
    setTipoPisoSeleccionado(0);
    setAccion('crear');
    setShowForm(true);
  };
      ...
      <Paper className={classes.paper}>
        {permisos && (
          <EnhancedTableToolbar
            ...
            onOpenAddTipoPiso={onOpenAddTipoPiso}
                        ...
                        <TableCell align='center' className={classes.acciones}>
                          {permisos.indexOf('Modificar') >= 0 && (
                            <Tooltip title={<IntlMessages id='boton.editar' />}>
                              <EditIcon
                                onClick={() => onOpenEditTipoPiso(row.id)}
