...
import TipoViviendaCreador from './TipoViviendaCreador';
import {
  onGetColeccion,
  onDelete,
} from '../../../redux/actions/TipoViviendaAction';
          ...
          <Box className={classes.titleTop}>
            ...
            <Box className={classes.horizontalBottoms}>
              ...
              {permisos.indexOf('Crear') >= 0 && (
                <Tooltip title='Crear Tipo Vivienda' onClick={onOpenAddTipoVivienda}>
                  <IconButton
...
EnhancedTableToolbar.propTypes = {
  numSelected: PropTypes.number.isRequired,
  onOpenAddTipoVivienda: PropTypes.func.isRequired,
...
const TipoVivienda = (props) => {
  ...
  const [tipoViviendaSeleccionado, setTipoViviendaSeleccionado] = useState(0);
  ...
  const onOpenEditTipoVivienda = (id) => {
    setTipoViviendaSeleccionado(id);
    setAccion('editar');
    setShowForm(true);
  };
  ...
  const onOpenViewTipoVivienda = (id) => {
    setTipoViviendaSeleccionado(id);
    setAccion('ver');
    setShowForm(true);
  };

  const onDeleteTipoVivienda = (id) => {
    Swal.fire({
      title: 'Confirmar',
      text: '¿Seguro Que Desea Eliminar El Tipo Vivienda?',
  ...
  const onOpenAddTipoVivienda = () => {
    setTipoViviendaSeleccionado(0);
    setAccion('crear');
    setShowForm(true);
  };
      ...
      <Paper className={classes.paper}>
        {permisos && (
          <EnhancedTableToolbar
            ...
            onOpenAddTipoVivienda={onOpenAddTipoVivienda}
                        ...
                        <TableCell align='center' className={classes.acciones}>
                          {permisos.indexOf('Modificar') >= 0 && (
                            <Tooltip title={<IntlMessages id='boton.editar' />}>
                              <EditIcon
                                onClick={() => onOpenEditTipoVivienda(row.id)}
                          ...
                          {permisos.indexOf('Listar') >= 0 && (
                            <Tooltip title={<IntlMessages id='boton.ver' />}>
                              <VisibilityIcon
                                onClick={() => onOpenViewTipoVivienda(row.id)}
                          ...
                          {permisos.indexOf('Eliminar') >= 0 && (
                            <Tooltip
                              ...
                              <DeleteIcon
                                onClick={() => onDeleteTipoVivienda(row.id)}
