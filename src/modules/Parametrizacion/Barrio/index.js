...
import BarrioCreador from './BarrioCreador';
import {
  onGetColeccion,
  onDelete,
          ...
          <Box className={classes.titleTop}>
            ...
            <Box className={classes.horizontalBottoms}>
              ...
              {permisos.indexOf('Crear') >= 0 && (
                <Tooltip title='Crear Barrio' onClick={onOpenAddBarrio}>
                  <IconButton
...
EnhancedTableToolbar.propTypes = {
  numSelected: PropTypes.number.isRequired,
  onOpenAddBarrio: PropTypes.func.isRequired,
...
const Barrios = (props) => {
  ...
  const [barrioSeleccionado, setBarrioSeleccionado] = useState(0);
  ...
  const onOpenViewBarrio = (id) => {
    setBarrioSeleccionado(id);
    setAccion('ver');
    setShowForm(true);
  };

  const onDeleteBarrio = (id) => {
    Swal.fire({
      title: 'Confirmar',
      text: '¿Seguro Que Desea Eliminar El barrio?',
  ...
  const onOpenAddBarrio = () => {
    setBarrioSeleccionado(0);
    setAccion('crear');
    setShowForm(true);
  };
      ...
      <Paper className={classes.paper}>
        {permisos && (
          <EnhancedTableToolbar
            ...
            onOpenAddBarrio={onOpenAddBarrio}
                        ...
                        <TableCell align='center' className={classes.acciones}>
                          {permisos.indexOf('Modificar') >= 0 && (
                            <Tooltip title={<IntlMessages id='boton.editar' />}>
                              <EditIcon
                                onClick={() => onOpenEditBarrio(row.id)}
                          ...
                          {permisos.indexOf('Listar') >= 0 && (
                            <Tooltip title={<IntlMessages id='boton.ver' />}>
                              <VisibilityIcon
                                onClick={() => onOpenViewBarrio(row.id)}
