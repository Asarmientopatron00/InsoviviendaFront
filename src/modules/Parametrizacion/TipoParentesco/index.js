...
import TipoParentescoCreador from './TipoParentescoCreador';
import {
  onGetColeccion,
  onDelete,
          ...
          <Box className={classes.titleTop}>
            ...
            <Box className={classes.horizontalBottoms}>
              ...
              {permisos.indexOf('Crear') >= 0 && (
                <Tooltip title='Crear Tipo de Parentesco' onClick={onOpenAddTipoParentesco}>
                  <IconButton
...
EnhancedTableToolbar.propTypes = {
  numSelected: PropTypes.number.isRequired,
  onOpenAddTipoParentesco: PropTypes.func.isRequired,
...
const TiposParentesco = (props) => {
  ...
  const [tipoParentescoSeleccionado, setTipoParentescoSeleccionado] = useState(0);
  ...
  const onOpenEditTipoParentesco = (id) => {
    setTipoParentescoSeleccionado(id);
    setAccion('editar');
    setShowForm(true);
  };
  ...
  const onOpenViewTipoParentesco = (id) => {
    setTipoParentescoSeleccionado(id);
    setAccion('ver');
    setShowForm(true);
  };

  const onDeleteTipoParentesco = (id) => {
    Swal.fire({
      title: 'Confirmar',
      text: '¿Seguro Que Desea Eliminar El Tipo de Parentesco?',
  ...
  const onOpenAddTipoParentesco = () => {
    setTipoParentescoSeleccionado(0);
    setAccion('crear');
    setShowForm(true);
  };
  ...
  return (
    <div className={classes.root}>
      <Paper className={classes.paper}>
        {permisos && (
          <EnhancedTableToolbar
            ...
            onOpenAddTipoParentesco={onOpenAddTipoParentesco}
                        ...
                        <TableCell align='center' className={classes.acciones}>
                          {permisos.indexOf('Modificar') >= 0 && (
                            <Tooltip title={<IntlMessages id='boton.editar' />}>
                              <EditIcon
                                onClick={() => onOpenEditTipoParentesco(row.id)}
                          ...
                          {permisos.indexOf('Listar') >= 0 && (
                            <Tooltip title={<IntlMessages id='boton.ver' />}>
                              <VisibilityIcon
                                onClick={() => onOpenViewTipoParentesco(row.id)}
                          ...
                          {permisos.indexOf('Eliminar') >= 0 && (
                            <Tooltip
                              ...
                              <DeleteIcon
                                onClick={() => onDeleteTipoParentesco(row.id)}
      ...
      {showForm ? (
        <TipoParentescoCreador
          showForm={showForm}
          tipoParentesco={tipoParentescoSeleccionado}
          accion={accion}
...
export default TiposParentesco;
