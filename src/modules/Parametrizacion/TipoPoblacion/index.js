...
import TipoPoblacionCreador from './TipoPoblacionCreador';

import {
  onGetColeccion,
  onDelete,
} from '../../../redux/actions/TipoPoblacionAction';
          ...
          <Box className={classes.titleTop}>
            ...
            <Box className={classes.horizontalBottoms}>
              ...
              {permisos.indexOf('Crear') >= 0 && (
                <Tooltip title='Crear Tipo Poblacion' onClick={onOpenAddTipoPoblacion}>
                  <IconButton
...
EnhancedTableToolbar.propTypes = {
  numSelected: PropTypes.number.isRequired,
  onOpenAddTipoPoblacion: PropTypes.func.isRequired,
...
const TipoPoblacion = (props) => {
  ...
  const [tipoPoblacionSeleccionado, setTipoPoblacionSeleccionado] = useState(0);
  ...
  const onOpenEditTipoPoblacion = (id) => {
    setTipoPoblacionSeleccionado(id);
    setAccion('editar');
    setShowForm(true);
  };
  ...
  const onDeleteTipoIdentificacion = (id) => {
    Swal.fire({
      title: 'Confirmar',
      text: '¿Seguro Que Desea Eliminar El Tipo Poblacion?',
  ...
  const onOpenAddTipoPoblacion = () => {
    setTipoPoblacionSeleccionado(0);
    setAccion('crear');
    setShowForm(true);
  };
  ...
  return (
    <div className={classes.root}>
      <Paper className={classes.paper}>
        {permisos && (
          <EnhancedTableToolbar
            ...
            onOpenAddTipoPoblacion={onOpenAddTipoPoblacion}
                        ...
                        <TableCell align='center' className={classes.acciones}>
                          {permisos.indexOf('Modificar') >= 0 && (
                            <Tooltip title={<IntlMessages id='boton.editar' />}>
                              <EditIcon
                                onClick={() => onOpenEditTipoPoblacion(row.id)}
      ...
      {showForm ? (
        <TipoPoblacionCreador
          showForm={showForm}
          tipoPoblacion={tipoPoblacionSeleccionado}
          accion={accion}
