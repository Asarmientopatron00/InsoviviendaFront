...
import TipoAsesoriaCreador from './TipoAsesoriaCreador';
import {
  onGetColeccion,
  onDelete,
          ...
          <Box className={classes.titleTop}>
            ...
            <Box className={classes.horizontalBottoms}>
              ...
              {permisos.indexOf('Crear') >= 0 && (
                <Tooltip title='Crear Tipo de Asesoria' onClick={onOpenAddTipoAsesoria}>
                  <IconButton
...
EnhancedTableToolbar.propTypes = {
  numSelected: PropTypes.number.isRequired,
  onOpenAddTipoAsesoria: PropTypes.func.isRequired,
...
const TiposAsesoria = (props) => {
  ...
  const [tipoAsesoriaSeleccionado, setTipoAsesoriaSeleccionado] = useState(0);
  ...
  const onOpenEditTipoAsesoria = (id) => {
    setTipoAsesoriaSeleccionado(id);
    setAccion('editar');
    setShowForm(true);
  };
  ...
  const onOpenViewTipoAsesoria = (id) => {
    setTipoAsesoriaSeleccionado(id);
    setAccion('ver');
    setShowForm(true);
  };

  const onDeleteTipoAsesoria = (id) => {
    Swal.fire({
      title: 'Confirmar',
      text: '¿Seguro Que Desea Eliminar El Tipo de Asesoria?',
  ...
  const onOpenAddTipoAsesoria = () => {
    setTipoAsesoriaSeleccionado(0);
    setAccion('crear');
    setShowForm(true);
  };
  ...
  return (
    <div className={classes.root}>
      <Paper className={classes.paper}>
        {permisos && (
          <EnhancedTableToolbar
            ...
            onOpenAddTipoAsesoria={onOpenAddTipoAsesoria}
                        ...
                        <TableCell align='center' className={classes.acciones}>
                          {permisos.indexOf('Modificar') >= 0 && (
                            <Tooltip title={<IntlMessages id='boton.editar' />}>
                              <EditIcon
                                onClick={() => onOpenEditTipoAsesoria(row.id)}
                          ...
                          {permisos.indexOf('Listar') >= 0 && (
                            <Tooltip title={<IntlMessages id='boton.ver' />}>
                              <VisibilityIcon
                                onClick={() => onOpenViewTipoAsesoria(row.id)}
                          ...
                          {permisos.indexOf('Eliminar') >= 0 && (
                            <Tooltip
                              ...
                              <DeleteIcon
                                onClick={() => onDeleteTipoAsesoria(row.id)}
      ...
      {showForm ? (
        <TipoAsesoriaCreador
          showForm={showForm}
          tipoAsesoria={tipoAsesoriaSeleccionado}
          accion={accion}
