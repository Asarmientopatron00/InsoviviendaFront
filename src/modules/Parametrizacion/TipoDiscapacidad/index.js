...
import TipoDiscapacidadCreador from './TipoDiscapacidadCreador';
import {
  onGetColeccion,
  onDelete,
} from '../../../redux/actions/TipoDiscapacidadAction';
          ...
          <Box className={classes.titleTop}>
            ...
            <Box className={classes.horizontalBottoms}>
              ...
              {permisos.indexOf('Crear') >= 0 && (
                <Tooltip title='Crear Tipo de Discapacidad' onClick={onOpenAddTipoDiscapacidad}>
                  <IconButton
...
EnhancedTableToolbar.propTypes = {
  numSelected: PropTypes.number.isRequired,
  onOpenAddTipoDiscapacidad: PropTypes.func.isRequired,
...
const TiposDiscapacidad = (props) => {
  ...
  const [tipoDiscapacidadSeleccionado, setTipoDiscapacidadSeleccionado] = useState(0);
  ...
  const onOpenEditTipoDiscapacidad = (id) => {
    setTipoDiscapacidadSeleccionado(id);
    setAccion('editar');
    setShowForm(true);
  };
  ...
  const onOpenViewTipoDiscapacidad = (id) => {
    setTipoDiscapacidadSeleccionado(id);
    setAccion('ver');
    setShowForm(true);
  };

  const onDeleteTipoDiscapacidad = (id) => {
    Swal.fire({
      title: 'Confirmar',
      text: '¿Seguro Que Desea Eliminar El Tipo de Discapacidad?',
  ...
  const onOpenAddTipoDiscapacidad = () => {
    setTipoDiscapacidadSeleccionado(0);
    setAccion('crear');
    setShowForm(true);
  };
  ...
  return (
    <div className={classes.root}>
      <Paper className={classes.paper}>
        {permisos && (
          <EnhancedTableToolbar
            ...
            onOpenAddTipoDiscapacidad={onOpenAddTipoDiscapacidad}
                        ...
                        <TableCell align='center' className={classes.acciones}>
                          {permisos.indexOf('Modificar') >= 0 && (
                            <Tooltip title={<IntlMessages id='boton.editar' />}>
                              <EditIcon
                                onClick={() => onOpenEditTipoDiscapacidad(row.id)}
                          ...
                          {permisos.indexOf('Listar') >= 0 && (
                            <Tooltip title={<IntlMessages id='boton.ver' />}>
                              <VisibilityIcon
                                onClick={() => onOpenViewTipoDiscapacidad(row.id)}
                          ...
                          {permisos.indexOf('Eliminar') >= 0 && (
                            <Tooltip
                              ...
                              <DeleteIcon
                                onClick={() => onDeleteTipoDiscapacidad(row.id)}
      ...
      {showForm ? (
        <TipoDiscapacidadCreador
          showForm={showForm}
          tipoDiscapacidad={tipoDiscapacidadSeleccionado}
          accion={accion}
...
export default TiposDiscapacidad;
