...
import TipofamiliaCreador from './TipofamiliaCreador';
import {
  onGetColeccion,
  onDelete,
} from '../../../redux/actions/TipofamiliaAction';
          ...
          <Box className={classes.titleTop}>
            ...
            <Box className={classes.horizontalBottoms}>
              ...
              {permisos.indexOf('Crear') >= 0 && (
                <Tooltip title='Crear Tipo Familia' onClick={onOpenAddtipoFamilia}>
                  <IconButton
...
EnhancedTableToolbar.propTypes = {
  numSelected: PropTypes.number.isRequired,
  onOpenAddtipoFamilia: PropTypes.func.isRequired,
...
const Tipofamilia = (props) => {
  ...
  const [tipoFamiliaSeleccionado, settipoFamiliaSeleccionado] = useState(0);
  ...
  const onOpenEdittipoFamilia = (id) => {
    settipoFamiliaSeleccionado(id);
    setAccion('editar');
    setShowForm(true);
  };
  ...
  const onOpenViewtipoFamilia = (id) => {
    settipoFamiliaSeleccionado(id);
    setAccion('ver');
    setShowForm(true);
  };

  const onDeletetipoFamilia = (id) => {
    Swal.fire({
      title: 'Confirmar',
      text: '¿Seguro Que Desea Eliminar El Tipo de Familia?',
  ...
  const onOpenAddtipoFamilia = () => {
    settipoFamiliaSeleccionado(0);
    setAccion('crear');
    setShowForm(true);
  };
  ...
  return (
    <div className={classes.root}>
      <Paper className={classes.paper}>
        {permisos && (
          <EnhancedTableToolbar
            ...
            onOpenAddtipoFamilia={onOpenAddtipoFamilia}
                        ...
                        <TableCell align='center' className={classes.acciones}>
                          {permisos.indexOf('Modificar') >= 0 && (
                            <Tooltip title={<IntlMessages id='boton.editar' />}>
                              <EditIcon
                                onClick={() => onOpenEdittipoFamilia(row.id)}
                          ...
                          {permisos.indexOf('Listar') >= 0 && (
                            <Tooltip title={<IntlMessages id='boton.ver' />}>
                              <VisibilityIcon
                                onClick={() => onOpenViewtipoFamilia(row.id)}
                          ...
                          {permisos.indexOf('Eliminar') >= 0 && (
                            <Tooltip
                              ...
                              <DeleteIcon
                                onClick={() => onDeletetipoFamilia(row.id)}
      ...
      {showForm ? (
        <TipofamiliaCreador
          showForm={showForm}
          Tipofamilia={tipoFamiliaSeleccionado}
          accion={accion}
