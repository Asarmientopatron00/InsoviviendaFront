...
import EstadocivilCreador from './EstadocivilCreador';
import {
  onGetColeccion,
  onDelete,
} from '../../../redux/actions/EstadocivilAction';
          ...
          <Box className={classes.titleTop}>
            ...
            <Box className={classes.horizontalBottoms}>
              ...
              {permisos.indexOf('Crear') >= 0 && (
                <Tooltip title='Crear Estado Civil' onClick={onOpenAddEstadoCivil}>
                  <IconButton
...
const Estadocivil = (props) => {
  ...
  const onOpenEditEstadoCivil = (id) => {
    setEstadoCivilSeleccionado(id);
    setAccion('editar');
    setShowForm(true);
  };
  ...
  const onOpenViewEstadoCivil = (id) => {
    setEstadoCivilSeleccionado(id);
    setAccion('ver');
    setShowForm(true);
  };

  const onDeleteEstadoCivil = (id) => {
    Swal.fire({
      title: 'Confirmar',
      text: '¿Seguro Que Desea Eliminar El Estado Civil?',
  ...
  const onOpenAddEstadoCivil = () => {
    setEstadoCivilSeleccionado(0);
    setAccion('crear');
    setShowForm(true);
  };
      ...
      <Paper className={classes.paper}>
        {permisos && (
          <EnhancedTableToolbar
            ...
            onOpenAddEstadoCivil={onOpenAddEstadoCivil}
                        ...
                        <TableCell align='center' className={classes.acciones}>
                          {permisos.indexOf('Modificar') >= 0 && (
                            <Tooltip title={<IntlMessages id='boton.editar' />}>
                              <EditIcon
                                onClick={() => onOpenEditEstadoCivil(row.id)}
                          ...
                          {permisos.indexOf('Listar') >= 0 && (
                            <Tooltip title={<IntlMessages id='boton.ver' />}>
                              <VisibilityIcon
                                onClick={() => onOpenViewEstadoCivil(row.id)}
                          ...
                          {permisos.indexOf('Eliminar') >= 0 && (
                            <Tooltip
                              ...
                              <DeleteIcon
                                onClick={() => onDeleteEstadoCivil(row.id)}
