...
import GradosescolaridadCreador from './GradosescolaridadCreador';
import {
  onGetColeccion,
  onDelete,
} from '../../../redux/actions/GradosescolaridadAction';
          ...
          <Box className={classes.titleTop}>
            ...
            <Box className={classes.horizontalBottoms}>
              ...
              {permisos.indexOf('Crear') >= 0 && (
                <Tooltip title='Crear Grado Escolaridad' onClick={onOpenAddGradosEscolaridad}>
                  <IconButton
...
EnhancedTableToolbar.propTypes = {
  numSelected: PropTypes.number.isRequired,
  onOpenAddGradosEscolaridad: PropTypes.func.isRequired,
...
const Gradosescolaridad = (props) => {
  ...
  const [GradosEscolaridadSeleccionado, setGradosEscolaridadSeleccionado] = useState(0);
  ...
  const onOpenEditGradosEscolaridad = (id) => {
    setGradosEscolaridadSeleccionado(id);
    setAccion('editar');
    setShowForm(true);
  };
  ...
  const onOpenViewGradosEscolaridad = (id) => {
    setGradosEscolaridadSeleccionado(id);
    setAccion('ver');
    setShowForm(true);
  };

  const onDeleteGradosEscolaridad = (id) => {
    Swal.fire({
      title: 'Confirmar',
      text: '¿Seguro Que Desea Eliminar el Grado de Escolaridad?',
  ...
  const onOpenAddGradosEscolaridad = () => {
    setGradosEscolaridadSeleccionado(0);
    setAccion('crear');
    setShowForm(true);
  };
  ...
  return (
    <div className={classes.root}>
      <Paper className={classes.paper}>
        {permisos && (
          <EnhancedTableToolbar
            ...
            onOpenAddGradosEscolaridad={onOpenAddGradosEscolaridad}
                        ...
                        <TableCell align='center' className={classes.acciones}>
                          {permisos.indexOf('Modificar') >= 0 && (
                            <Tooltip title={<IntlMessages id='boton.editar' />}>
                              <EditIcon
                                onClick={() => onOpenEditGradosEscolaridad(row.id)}
                          ...
                          {permisos.indexOf('Listar') >= 0 && (
                            <Tooltip title={<IntlMessages id='boton.ver' />}>
                              <VisibilityIcon
                                onClick={() => onOpenViewGradosEscolaridad(row.id)}
                          ...
                          {permisos.indexOf('Eliminar') >= 0 && (
                            <Tooltip
                              ...
                              <DeleteIcon
                                onClick={() => onDeleteGradosEscolaridad(row.id)}
      ...
      {showForm ? (
        <GradosescolaridadCreador
          showForm={showForm}
          GradosEscolaridad={GradosEscolaridadSeleccionado}
          accion={accion}
...
export default Gradosescolaridad;
