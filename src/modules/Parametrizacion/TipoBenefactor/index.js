...
import TipoBenefactorCreador from './TipoBenefactorCreador';
import {
  onGetColeccion,
  onDelete,
} from '../../../redux/actions/TipoBenefactorAction';
          ...
          <Box className={classes.titleTop}>
            ...
            <Box className={classes.horizontalBottoms}>
              ...
              {permisos.indexOf('Crear') >= 0 && (
                <Tooltip title='Crear Tipo benefactor' onClick={onOpenAddTipoBenefactor}>
                  <IconButton
...
EnhancedTableToolbar.propTypes = {
  numSelected: PropTypes.number.isRequired,
  onOpenAddTipoBenefactor: PropTypes.func.isRequired,
...
const TiposBenefactor = (props) => {
  ...
  const [tipoBenefactorSeleccionado, setTipoBenefactorSeleccionado] = useState(0);
  ...
  const onOpenEditTipoBenefactor = (id) => {
    setTipoBenefactorSeleccionado(id);
    setAccion('editar');
    setShowForm(true);
  };
  ...
  const onOpenViewTipoBenefactor = (id) => {
    setTipoBenefactorSeleccionado(id);
    setAccion('ver');
    setShowForm(true);
  };

  const onDeleteTipoBenefactor = (id) => {
    Swal.fire({
      title: 'Confirmar',
      text: '¿Seguro que desea eliminar el Tipo de benefactor?',
  ...
  const onOpenAddTipoBenefactor = () => {
    setTipoBenefactorSeleccionado(0);
    setAccion('crear');
    setShowForm(true);
  };
  ...
  return (
    <div className={classes.root}>
      <Paper className={classes.paper}>
        {permisos && (
          <EnhancedTableToolbar
            ...
            onOpenAddTipoBenefactor={onOpenAddTipoBenefactor}
                        ...
                        <TableCell align='center' className={classes.acciones}>
                          {permisos.indexOf('Modificar') >= 0 && (
                            <Tooltip title={<IntlMessages id='boton.editar' />}>
                              <EditIcon
                                onClick={() => onOpenEditTipoBenefactor(row.id)}
                          ...
                          {permisos.indexOf('Listar') >= 0 && (
                            <Tooltip title={<IntlMessages id='boton.ver' />}>
                              <VisibilityIcon
                                onClick={() => onOpenViewTipoBenefactor(row.id)}
                          ...
                          {permisos.indexOf('Eliminar') >= 0 && (
                            <Tooltip
                              ...
                              <DeleteIcon
                                onClick={() => onDeleteTipoBenefactor(row.id)}
      ...
      {showForm ? (
        <TipoBenefactorCreador
          showForm={showForm}
          tipoBenefactor={tipoBenefactorSeleccionado}
          accion={accion}
...
export default TiposBenefactor;
