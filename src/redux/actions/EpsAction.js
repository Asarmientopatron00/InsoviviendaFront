      ...
      jwtAxios
        ...
        .then((data) => {
          if (data.status === 200) {
            ...
            dispatch({type: GET_COLECCION_EPS, payload: data});
          } else {
            dispatch({
              type: FETCH_ERROR,
    ...
    return (dispatch) => {
      ...
      jwtAxios
        ...
        .then((data) => {
          if (data.status === 200) {
            dispatch({type: FETCH_SUCCESS});
            dispatch({type: GET_COLECCION_LIGERA_EPS, payload: data});
          } else {
            dispatch({
              type: FETCH_ERROR,
              payload: messages['message.somethingWentWrong'],
      ...
      if (id !== 0) {
        ...
        jwtAxios
          ...
          .then((data) => {
            if (data.status === 200) {
              dispatch({type: FETCH_SUCCESS});
              dispatch({type: SHOW_EPS, payload: data.data});
            } else {
              dispatch({
                type: FETCH_ERROR,
                payload: messages['message.somethingWentWrong'],
      ...
      jwtAxios
        ...
        .then((data) => {
          if (data.status === 200) {
            ...
            dispatch({type: DELETE_EPS, payload: data.data});
          } else {
